export const COURSE_PATTERNS: Array<{ label: string; patterns: RegExp[] }> = [
  ...
  { label: "Differential Equations", patterns: [/differential\s*equations?/i, /\bdiff\s*eq\b/i, /\bde\b/i, /\bode\b/i] },
  { label: "Statistics", patterns: [/\bstats?\b/i, /\bstatistics\b/i] },
  { label: "Elementary Algebra", patterns: [/elementary\s*algebra/i, /\belem(?:entary)?\s*alg(?:ebra)?\b/i, /\balgebra\b/i] },
];
