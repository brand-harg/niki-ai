...
const scenarios = [
  ...
  },
  {
    ...
    expect: [/(Next,\s*|Then )apply the formula to this problem/i, /\\frac\{d\}\{dx\}\\left\(5x\\right\)=5\\cdot\\frac\{d\}\{dx\}\(x\)=5\\cdot 1/i],
    reject: [/Qwen/i],
  },
  {
    ...
    expect: [/(Next,\s*|Then )apply the formula to this problem/i, /Inner function:/i, /Outer function:/i, /\\cos\\left\(x\^\{2\}\\right\)\\cdot2x/i],
    reject: [/Qwen/i],
  },
  {
    ...
    expect: [
      /(?:Next,\s*|Then )apply the formula to this problem/i,
      /u&=\\sin/i,
      /v&=e\^\{2x\}/i,
      /u'&=\\cos/i,
      /v'&=2e\^\{2x\}/i,
